function Get-M365MailboxSizes {
    ...
    $mailboxes = Get-EXOMailbox -ResultSize Unlimited | Select-Object DisplayName, UserPrincipalName, RecipientTypeDetails, @{Name = 'TotalItemSize'; Expression = { Get-EXOMailboxStatistics $_.UserPrincipalName } }
...
Export-ModuleMember -Function Get-M365MailboxSizes